...
var _config_style = {
  ...
  toolkit: _SOURCE_FOLDER + 'css/style-guide.styl',
  sections: 'sections',
...
/**
 * Compila y concatena los archivo STYLUS y genera los estilos
...
var _analyzeModifiedFile = function (path,file,level,folders,ext){
  ...
  switch( data.ext ){
    ...
    case _EXTENSIONS.CSS: _compileStylus(data); break;
